...
import burp.yaml.YamlBeanFromJson;
import burp.yaml.YamlBeanFromMap;
import burp.yaml.YamlInfo;
...
public class NucleiParser {
	...
	public static FioraLineEntry Parser(String pocfile) {
		FioraLineEntry result = new FioraLineEntry();
