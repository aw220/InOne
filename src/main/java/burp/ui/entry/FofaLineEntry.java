...
public class FofaLineEntry{
	...
	private String title = "";// 资产网页title
	private String country_name = "";// 资产网页title
	private String server = "";// 资产网页title
	private String protocol = "";// 资产网页title
	private String type = "";// 资产网页title
	...
	public static LinkedHashMap<String,Integer> fetchTableHeaderAndWidth(){
		if (preferredWidths.isEmpty()) {
			...
			preferredWidths.put("country_name", 20);
